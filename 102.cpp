...
// Реализую потом, ACMP просто наелся и спит. Мысль до безобразия проста. Составить уравнения прямой по двум точкам (привет линал), а дальше взять в систему три уравнения (неравенства)
